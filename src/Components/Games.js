  ...
  return (
    <div className="flex flex-col mt-16 w-full justify-center">
      ...
      {load ? (
        <div
          id="load"
          className="w-auto h-screen flex items-center justify-center -mt-10"
        >
          <svg
        ...
        <div className="h-auto w-full bg-grey-300 dark:bg-gray-900 text-gray-800 dark:text-gray-100 flex items-center justify-items-center p-4 flex-wrap justify-center">
          {games.map((e) => {
            return (
              <Link
                to={`/games/${e.id}`}
